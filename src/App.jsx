...
function App() {
    ...
    return (
        <BrowserRouter>
                ...
                <div className="app">
                    ...
                    : <nav className="mobile-nav">
                        ...
                        <div className={`menu-panel ${openMenu ? "show" : ""}`}>
                            ...
                            <Link to="/history" onClick={() => setOpenMenu(false)}>History</Link>
            ...
            <footer>© Soulvers3, 2023 — {new Date().getFullYear()}. Made by Soulvers3records & Andrew Aldor</footer>
        </BrowserRouter>
    )
}
